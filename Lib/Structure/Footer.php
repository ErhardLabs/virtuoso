...
class Footer {
	...
	public function __construct() {
		...
		$this->footer_layout = get_theme_mod( 'genesis-settings' )[ $prefix . '_footer_design' ];
	 ...
	 * @return array
	 */
	public function set_footer_class( $classes ) {

		if ( 'footer-widgets-block' === $this->footer_layout ) {
			$classes[] .= ' footer-widgets-block';
		} elseif ( 'footer-widgets-left-column' === $this->footer_layout ) {
